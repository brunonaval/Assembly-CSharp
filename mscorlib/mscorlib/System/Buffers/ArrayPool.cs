...
namespace System.Buffers
{
	...
	public abstract class ArrayPool<T>
	{
		...
		// (get) Token: 0x060062CD RID: 25293 RVA: 0x0014A548 File Offset: 0x00148748
		public static ArrayPool<T> Shared { get; } = new TlsOverPerCoreLockedStacksArrayPool<T>();

		// Token: 0x060062CE RID: 25294 RVA: 0x0014A54F File Offset: 0x0014874F
		public static ArrayPool<T> Create()
		{
			return new ConfigurableArrayPool<T>();
		}

		// Token: 0x060062CF RID: 25295 RVA: 0x0014A556 File Offset: 0x00148756
