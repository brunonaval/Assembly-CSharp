...
namespace System.Security.Cryptography
{
	...
	public class RIPEMD160Managed : RIPEMD160
	{
		...
		// Token: 0x06002FA5 RID: 12197 RVA: 0x000AAFC4 File Offset: 0x000A91C4
		...
		// Token: 0x06002FA6 RID: 12198 RVA: 0x000AB01A File Offset: 0x000A921A
		...
		// Token: 0x06002FA7 RID: 12199 RVA: 0x000AB04A File Offset: 0x000A924A
		...
		// Token: 0x06002FA8 RID: 12200 RVA: 0x000AB055 File Offset: 0x000A9255
		[SecuritySafeCritical]
		...
		// Token: 0x06002FA9 RID: 12201 RVA: 0x000AB060 File Offset: 0x000A9260
		...
		// Token: 0x06002FAA RID: 12202 RVA: 0x000AB0B8 File Offset: 0x000A92B8
		[SecurityCritical]
		private unsafe void _HashData(byte[] partIn, int ibStart, int cbSize)
		{
			...
			if (num2 > 0 && num2 + i >= 64)
			{
				...
				num += 64 - num2;
				i -= 64 - num2;
				RIPEMD160Managed.MDTransform(blockDWords, state, block);
				num2 = 0;
			}
			while (i >= 64)
			{
		...
		// Token: 0x06002FAB RID: 12203 RVA: 0x000AB1CC File Offset: 0x000A93CC
		[SecurityCritical]
		...
		// Token: 0x06002FAC RID: 12204 RVA: 0x000AB2B8 File Offset: 0x000A94B8
		[SecurityCritical]
		...
		// Token: 0x06002FAD RID: 12205 RVA: 0x000AD429 File Offset: 0x000AB629
		private static uint F(uint x, uint y, uint z)
		{
			return x ^ y ^ z;
		}

		// Token: 0x06002FAE RID: 12206 RVA: 0x000AD430 File Offset: 0x000AB630
		private static uint G(uint x, uint y, uint z)
		{
			return (x & y) | (~x & z);
		}

		// Token: 0x06002FAF RID: 12207 RVA: 0x000AD43A File Offset: 0x000AB63A
		private static uint H(uint x, uint y, uint z)
		{
			return (x | ~y) ^ z;
		}

		// Token: 0x06002FB0 RID: 12208 RVA: 0x000AD442 File Offset: 0x000AB642
		private static uint I(uint x, uint y, uint z)
		{
			return (x & z) | (y & ~z);
		}

		// Token: 0x06002FB1 RID: 12209 RVA: 0x000AD44C File Offset: 0x000AB64C
