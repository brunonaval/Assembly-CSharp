...
namespace System.Security.Cryptography
{
	...
	public class SHA512Managed : SHA512
	{
		...
		// Token: 0x06003063 RID: 12387 RVA: 0x000B0390 File Offset: 0x000AE590
		...
		// Token: 0x06003064 RID: 12388 RVA: 0x000B03E9 File Offset: 0x000AE5E9
		...
		// Token: 0x06003065 RID: 12389 RVA: 0x000B0419 File Offset: 0x000AE619
		...
		// Token: 0x06003066 RID: 12390 RVA: 0x000B0424 File Offset: 0x000AE624
		[SecuritySafeCritical]
		...
		// Token: 0x06003067 RID: 12391 RVA: 0x000B042C File Offset: 0x000AE62C
		...
		// Token: 0x06003068 RID: 12392 RVA: 0x000B04CC File Offset: 0x000AE6CC
		[SecurityCritical]
		...
		// Token: 0x06003069 RID: 12393 RVA: 0x000B05F8 File Offset: 0x000AE7F8
		[SecurityCritical]
		...
		// Token: 0x0600306A RID: 12394 RVA: 0x000B06EC File Offset: 0x000AE8EC
		[SecurityCritical]
		...
		// Token: 0x0600306B RID: 12395 RVA: 0x000B0271 File Offset: 0x000AE471
		private static ulong RotateRight(ulong x, int n)
		{
			return x >> n | x << 64 - n;
		}

		// Token: 0x0600306C RID: 12396 RVA: 0x000B0283 File Offset: 0x000AE483
		private static ulong Ch(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ ((x ^ ulong.MaxValue) & z);
		}

		// Token: 0x0600306D RID: 12397 RVA: 0x000AFAEA File Offset: 0x000ADCEA
		private static ulong Maj(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x0600306E RID: 12398 RVA: 0x000B0A09 File Offset: 0x000AEC09
		private static ulong Sigma_0(ulong x)
		{
			return SHA512Managed.RotateRight(x, 28) ^ SHA512Managed.RotateRight(x, 34) ^ SHA512Managed.RotateRight(x, 39);
		}

		// Token: 0x0600306F RID: 12399 RVA: 0x000B0A25 File Offset: 0x000AEC25
		private static ulong Sigma_1(ulong x)
		{
			return SHA512Managed.RotateRight(x, 14) ^ SHA512Managed.RotateRight(x, 18) ^ SHA512Managed.RotateRight(x, 41);
		}

		// Token: 0x06003070 RID: 12400 RVA: 0x000B0A41 File Offset: 0x000AEC41
		private static ulong sigma_0(ulong x)
		{
			return SHA512Managed.RotateRight(x, 1) ^ SHA512Managed.RotateRight(x, 8) ^ x >> 7;
		}

		// Token: 0x06003071 RID: 12401 RVA: 0x000B0A56 File Offset: 0x000AEC56
		private static ulong sigma_1(ulong x)
		{
			return SHA512Managed.RotateRight(x, 19) ^ SHA512Managed.RotateRight(x, 61) ^ x >> 6;
		}

		// Token: 0x06003072 RID: 12402 RVA: 0x000B0A70 File Offset: 0x000AEC70
		[SecurityCritical]
