...
namespace System.Security.Cryptography
{
	...
	public class SHA384Managed : SHA384
	{
		...
		// Token: 0x0600304F RID: 12367 RVA: 0x000AFBF8 File Offset: 0x000ADDF8
		...
		// Token: 0x06003050 RID: 12368 RVA: 0x000AFC51 File Offset: 0x000ADE51
		...
		// Token: 0x06003051 RID: 12369 RVA: 0x000AFC81 File Offset: 0x000ADE81
		...
		// Token: 0x06003052 RID: 12370 RVA: 0x000AFC8C File Offset: 0x000ADE8C
		[SecuritySafeCritical]
		...
		// Token: 0x06003053 RID: 12371 RVA: 0x000AFC94 File Offset: 0x000ADE94
		...
		// Token: 0x06003054 RID: 12372 RVA: 0x000AFD34 File Offset: 0x000ADF34
		[SecurityCritical]
		...
		// Token: 0x06003055 RID: 12373 RVA: 0x000AFE60 File Offset: 0x000AE060
		[SecurityCritical]
		...
		// Token: 0x06003056 RID: 12374 RVA: 0x000AFF54 File Offset: 0x000AE154
		[SecurityCritical]
		...
		// Token: 0x06003057 RID: 12375 RVA: 0x000B0271 File Offset: 0x000AE471
		private static ulong RotateRight(ulong x, int n)
		{
			return x >> n | x << 64 - n;
		}

		// Token: 0x06003058 RID: 12376 RVA: 0x000B0283 File Offset: 0x000AE483
		private static ulong Ch(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ ((x ^ ulong.MaxValue) & z);
		}

		// Token: 0x06003059 RID: 12377 RVA: 0x000AFAEA File Offset: 0x000ADCEA
		private static ulong Maj(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x0600305A RID: 12378 RVA: 0x000B028F File Offset: 0x000AE48F
		private static ulong Sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 28) ^ SHA384Managed.RotateRight(x, 34) ^ SHA384Managed.RotateRight(x, 39);
		}

		// Token: 0x0600305B RID: 12379 RVA: 0x000B02AB File Offset: 0x000AE4AB
		private static ulong Sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 14) ^ SHA384Managed.RotateRight(x, 18) ^ SHA384Managed.RotateRight(x, 41);
		}

		// Token: 0x0600305C RID: 12380 RVA: 0x000B02C7 File Offset: 0x000AE4C7
		private static ulong sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 1) ^ SHA384Managed.RotateRight(x, 8) ^ x >> 7;
		}

		// Token: 0x0600305D RID: 12381 RVA: 0x000B02DC File Offset: 0x000AE4DC
		private static ulong sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 19) ^ SHA384Managed.RotateRight(x, 61) ^ x >> 6;
		}

		// Token: 0x0600305E RID: 12382 RVA: 0x000B02F4 File Offset: 0x000AE4F4
		[SecurityCritical]
