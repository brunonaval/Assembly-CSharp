...
namespace System.Threading
{
	...
	internal static class AsyncLocalValueMap
	{
		...
		// (get) Token: 0x06001D66 RID: 7526 RVA: 0x0006DB5C File Offset: 0x0006BD5C
		...
		{
			// Token: 0x06001D68 RID: 7528 RVA: 0x0006DB70 File Offset: 0x0006BD70
			...
			// Token: 0x06001D69 RID: 7529 RVA: 0x0006DB8D File Offset: 0x0006BD8D
		...
		{
			// Token: 0x06001D6B RID: 7531 RVA: 0x0006DB93 File Offset: 0x0006BD93
			...
			// Token: 0x06001D6C RID: 7532 RVA: 0x0006DBAC File Offset: 0x0006BDAC
			public IAsyncLocalValueMap Set(IAsyncLocal key, object value)
			{
				if (value != null)
				{
			...
			// Token: 0x06001D6D RID: 7533 RVA: 0x0006DBF7 File Offset: 0x0006BDF7
			public bool TryGetValue(IAsyncLocal key, out object value)
			{
				if (key == this._key1)
				{
		...
		{
			// Token: 0x06001D6E RID: 7534 RVA: 0x0006DC10 File Offset: 0x0006BE10
			...
			// Token: 0x06001D6F RID: 7535 RVA: 0x0006DC38 File Offset: 0x0006BE38
			public IAsyncLocalValueMap Set(IAsyncLocal key, object value)
			{
				if (value != null)
				{
			...
			// Token: 0x06001D70 RID: 7536 RVA: 0x0006DCE5 File Offset: 0x0006BEE5
			public bool TryGetValue(IAsyncLocal key, out object value)
			{
				if (key == this._key1)
				{
		...
		{
			// Token: 0x06001D71 RID: 7537 RVA: 0x0006DD11 File Offset: 0x0006BF11
			...
			// Token: 0x06001D72 RID: 7538 RVA: 0x0006DD48 File Offset: 0x0006BF48
			public IAsyncLocalValueMap Set(IAsyncLocal key, object value)
			{
				if (value != null)
				{
			...
			// Token: 0x06001D73 RID: 7539 RVA: 0x0006DE9D File Offset: 0x0006C09D
			public bool TryGetValue(IAsyncLocal key, out object value)
			{
				if (key == this._key1)
				{
		...
		{
			// Token: 0x06001D74 RID: 7540 RVA: 0x0006DEDC File Offset: 0x0006C0DC
			internal MultiElementAsyncLocalValueMap(int count)
			{
				this._keyValues = new KeyValuePair<IAsyncLocal, object>[count];
			}

			// Token: 0x06001D75 RID: 7541 RVA: 0x0006DEF0 File Offset: 0x0006C0F0
			...
			// Token: 0x06001D76 RID: 7542 RVA: 0x0006DF08 File Offset: 0x0006C108
			public IAsyncLocalValueMap Set(IAsyncLocal key, object value)
			{
				int i = 0;
			...
			// Token: 0x06001D77 RID: 7543 RVA: 0x0006E260 File Offset: 0x0006C460
			public bool TryGetValue(IAsyncLocal key, out object value)
			{
				foreach (KeyValuePair<IAsyncLocal, object> keyValuePair in this._keyValues)
				{
		...
		{
			// Token: 0x06001D78 RID: 7544 RVA: 0x0006E2A3 File Offset: 0x0006C4A3
			public ManyElementAsyncLocalValueMap(int capacity) : base(capacity)
			{
			}

			// Token: 0x06001D79 RID: 7545 RVA: 0x0006E2AC File Offset: 0x0006C4AC
			public IAsyncLocalValueMap Set(IAsyncLocal key, object value)
			{
